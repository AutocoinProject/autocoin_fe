...
export default function BithumbBotPage() {
  ...
  const [transactions, setTransactions] = useState([
    { id: 1, type: 'BUY', coin: 'BTC', amount: 0.02, price: 83400000, timestamp: new Date().toISOString() },
    { id: 2, type: 'SELL', coin: 'ETH', amount: 0.8, price: 4180000, timestamp: new Date().toISOString() },
  ]);
  
  const [walletBalance, setWalletBalance] = useState([
    { coin: 'BTC', amount: 0.12, valueKRW: 10008000 },
    { coin: 'ETH', amount: 1.5, valueKRW: 6270000 },
    { coin: 'KRW', amount: 3500000, valueKRW: 3500000 },
  ]);
  
  // 사용 가능한 코인 및 전략 목록 (한국 거래소용)
  const availableCoins = ['BTC', 'ETH', 'XRP', 'ETC', 'ADA', 'SOL', 'BAT', 'BTG', 'BCH', 'MANA'];
  ...
  return (
    <div className="p-6 max-w-full">
      <h1 className="text-2xl font-bold mb-6">빗썸 트레이딩 봇</h1>
